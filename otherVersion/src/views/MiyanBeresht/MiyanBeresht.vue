<template>
  <section class="hero-shell brand-surface brand-surface--beresht w-full h-screen flex items-center justify-center overflow-hidden">
  ...
  <StickyNavbar
    ...
    surface-class="brand-surface brand-surface--beresht"
  />

  <!-- Child Router View -->
  <div ref="childSwipe" class="child-swipe-wrapper brand-surface brand-surface--beresht">
